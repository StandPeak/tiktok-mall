...
public class CacheConfiguration {
    ...
    // 配置缓存 manager
    @Bean
    @Primary // 同类型，多个 bean，默认生效！默认缓存时间 1 小时！可以选择！
    public RedisCacheManager cacheManagerHour(RedisConnectionFactory redisConnectionFactory) {
        RedisCacheConfiguration instanceConfig = instanceConfig(1 * 3600L); // 缓存时间 1 小时
    ...
    public RedisCacheManager cacheManagerDay(RedisConnectionFactory redisConnectionFactory) {
        RedisCacheConfiguration instanceConfig = instanceConfig(24 * 3600L); // 缓存时间 1 小时
